...
В задаче использовал промисы (как для чтения, так и для оформления решения). 
Этот паттерн был использован как для изучения промисов, так и для единства дизайна кода.